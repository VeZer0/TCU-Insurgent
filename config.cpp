...
{
	#include "TCU_SABR\TCU_SABR_Factions.hpp"
	#include "TCU_SPEC\TCU_SPEC_Factions.hpp"
	#include "TCU_ZENT\TCU_ZENT_Factions.hpp"

};

class CfgVehicleClasses
{
	#include "TCU_SABR\TCU_SABR_vehicleClasses.hpp"
	#include "TCU_SPEC\TCU_SPEC_vehicleClasses.hpp"
	#include "TCU_ZENT\TCU_ZENT_vehicleClasses.hpp"
...
class CfgVehicles
{
	...
	#include "TCU_SABR\TCU_SABR_cfgVehicles_Units.hpp"
	#include "TCU_SPEC\TCU_SPEC_cfgVehicles_Units.hpp"
	#include "TCU_ZENT\TCU_ZENT_cfgVehicles_Units.hpp"
	...
	#include "TCU_SABR\TCU_SABR_cfgVehicles_assets.hpp"
	#include "TCU_SPEC\TCU_SPEC_cfgVehicles_assets.hpp"
	#include "TCU_ZENT\TCU_ZENT_cfgVehicles_assets.hpp"
	...
	#include "TCU_SABR\TCU_SABR_cfgVehicles_Packs.hpp"
	#include "TCU_SPEC\TCU_SPEC_cfgVehicles_Packs.hpp"
	#include "TCU_ZENT\TCU_ZENT_cfgVehicles_Packs.hpp"
	...
	#include "TCU_SABR\TCU_SABR_cfgVehicles_AmmoBox.hpp"
	#include "TCU_SPEC\TCU_SPEC_cfgVehicles_AmmoBox.hpp"
	#include "TCU_ZENT\TCU_ZENT_cfgVehicles_AmmoBox.hpp"
...
class CfgWeapons
{
	...
	#include "TCU_SABR\TCU_SABR_cfgWeapons.hpp"
	#include "TCU_SPEC\TCU_SPEC_cfgWeapons.hpp"
